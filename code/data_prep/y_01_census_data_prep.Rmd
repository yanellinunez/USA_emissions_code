...
- Economic variables were not collected through the 2010 decennial census. So we obtained from the ACS 3-year average (2008-2012) as proxy to 2010 estimates. In the dataset, I labeled 2008-20012 as 2010 to match the year levels of the race/ethnicity data

- Note that for the analysis we will not need 2010 demographic data only 1970-2000 so we do not have to worry about the fact that economic data is only available through the 2008-2012 ACS and not the 2010 census. We including 2010 data here just because it is already in the data files but we will not need it in the analysis
...
- Median house value for 2010 comes from the ACS 2008-2012 which is adjusted to 2012 inflation. Again, we do not used this in the analysis because we only need demographic data up to 2000.
...
Notes: 
- For 2010 we using the ACS from 2008-2012 which is adjusted to 2012 inflation. Again, we do not used this in the analysis because we only need demographic data up to 2000.
...
- Income data are only available as a categorical variable or aggregated for year 1970 so we aren't not including 1970 data here
