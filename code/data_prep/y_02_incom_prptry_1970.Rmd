...
Estimate property and income for 1970 using aggregate values and household counts. We are doing this because for 1970 we have a categorical variable for median household income and property value but we want to use a continuous variable. Here we try multiple ways of estimating the values for 1970. 

Conclusions:

We selected family mean income as the proxi to family median income for 1970. The correlation between the estimated mean family for 1970 and median family income for 1980 is 0.84. Overall all the estimated mean income is much lower than the median family income. 
...
Notes:
- The information in this dataset comes all from decennial census 
- DC doesn't appear in this datasets for some reason
...
NOTE: For property value we have a negative number for Yellowstone National Park
...
### b. Merge 1970 estimates with  covariates
