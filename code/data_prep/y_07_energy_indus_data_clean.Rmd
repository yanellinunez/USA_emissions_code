...
We select the 95th percentile of the data to avoid extremely large values that are generated when a county's reference year has a extremely low emission flux
