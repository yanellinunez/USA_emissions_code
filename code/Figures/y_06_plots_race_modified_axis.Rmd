...
models_trans$plots[[i]]$layers[[3]] <- NULL

plot_scaled <- models_trans$plots[[i]] +
               coord_trans(x = get(models_trans$trans_type[[i]]), expand = FALSE) +
  geom_segment(aes(x = 0, y = 0, xend = models_trans$xend[[i]], yend = 0), linetype = 2, size =0.5) +
...
transf_axis$plots_scaled[[12]]
models_trans$plots[[12]] 
...
models_nonlin_blk_wht_edit <- foreach(i = iterators::icount(nrow(models_nonlin_blk_wht)), 
                             .combine = rbind) %do% { 

models_nonlin_blk_wht$plots_white[[1]]$layers[[3]] <- NULL

models_nonlin_blk_wht

}

rm(models_nonlin_blk_wht)

nh3_agric_perc_white <- models_nonlin_blk_wht_edit$plots_white[[1]] +
                        coord_trans(x = trans_sqr, expand = FALSE) +
    geom_segment(aes(x = 0, y = 0, xend = 100, yend = 0), linetype = 2, size =0.5) 

nox_commer_perc_white <- models_nonlin_blk_wht_edit$plots_white[[2]] +
                        coord_trans(x = trans_sqr, expand = FALSE) +
    geom_segment(aes(x = 0, y = 0, xend = 100, yend = 0), linetype = 2, size =0.5) 

nox_trans_perc_white <- models_nonlin_blk_wht_edit$plots_white[[3]] +
                        coord_trans(x = trans_sqr, expand = FALSE) +
    geom_segment(aes(x = 0, y = 0, xend = 100, yend = 0), linetype = 2, size =0.5) 

so2_energy_perc_white <- models_nonlin_blk_wht_edit$plots_white[[4]] +
                        coord_trans(x = trans_sqr, expand = FALSE) +
    geom_segment(aes(x = 0, y = 0, xend = 100, yend = 0), linetype = 2, size =0.5) 


## Percent Black
nh3_agric_perc_black <- models_nonlin_blk_wht_edit$plots[[1]] +
           coord_trans(x = trans_sqr_root, expand = FALSE) +
    geom_segment(aes(x = 0, y = 0, xend = 100, yend = 0), linetype = 2, size =0.5) 

nox_commer_perc_black <- models_nonlin_blk_wht_edit$plots[[2]] +
           coord_trans(x = trans_sqr_root, expand = FALSE) +
    geom_segment(aes(x = 0, y = 0, xend = 100, yend = 0), linetype = 2, size =0.5) 

nox_trans_perc_black <- models_nonlin_blk_wht_edit$plots[[3]] +
           coord_trans(x = trans_sqr_root, expand = FALSE) +
    geom_segment(aes(x = 0, y = 0, xend = 100, yend = 0), linetype = 2, size =0.5) 

so2_energy_perc_black <- models_nonlin_blk_wht_edit$plots[[4]] +
           coord_trans(x = trans_sqr_root, expand = FALSE) +
    geom_segment(aes(x = 0, y = 0, xend = 100, yend = 0), linetype = 2, size =0.5) 
