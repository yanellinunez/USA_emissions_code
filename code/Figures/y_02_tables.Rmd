...
Estimate mean and IQR for the emission fluxes for all study years
...
table_3 %>%
  gtsummary::as_flex_table() %>%
  flextable::save_as_docx(path = paste0(figures.folder,'table_3_emissions_summ.docx'))
```
...
table_4 <- tbl_merge(list(table_4a, table_4b)) %>%
...
table_4 %>%
 gtsummary::as_flex_table() %>%
  flextable::save_as_docx(path = paste0(figures.folder,'table_4_change.docx'))
