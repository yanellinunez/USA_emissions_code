...
Make supplemental figure FS.6

Note: you won't be able to run this code because the models are saved in my local drive (the files are way too big for GitHub)
