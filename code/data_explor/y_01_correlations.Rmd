...
melted_cormat$x_label <- factor(melted_cormat$X2, labels = c("Population~density", "Property~Value", "Family~Income", "'%'*Unemployment", "'%'*Poverty", "'%'*Hispanic", "'%'*American~Native",  "'%'*Asian", "'%'*Black","'%'*White"))
