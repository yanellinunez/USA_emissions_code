...
Note that while re-running the models, I found minor discrepancies in the code with some of the foreach() loop refering to the wrong dataset. This is why I re-run all models rather than just the industry SO2.
...
#saveRDS(models_nonlin_eco, paste0(yanelli_external, "results_updated/models_nonlin_eco_hisp_revised.rds"))

```

**waiting for this code chunk to run**
...
#saveRDS(models_nonlin_race, paste0(yanelli_external, "results_updated/models_nonlin_asian_an_revised.rds"))
...
# saveRDS(models_nonlin_blk_wht, paste0(yanelli_external, "results_updated/models_nonlin_blk_wht_revised.rds"))
...
#saveRDS(linear_plots, paste0(yanelli_external, "results_updated/models_linear_revised.rds"))
...
#saveRDS(nonl_white_plots, paste0(yanelli_external, "results_updated/models_nonlin_wht_revised.rds"))
