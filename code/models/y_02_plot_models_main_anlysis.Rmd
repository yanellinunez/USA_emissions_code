...
Plot the updated dose-responses 
...
### 1a. Combine datasets
Merging some of the datasets together to make the next steps esier
```{r}
...
# extract using assign and foreach()
